...
class reportDetailViewController: UIViewController {
    ...
    func reportVideo(reportReason: String){
        ...
        ApiHandler.sharedInstance.reportVideo(user_id: UserDefaults.standard.string(forKey: "TimeLine_id")!, video_id: videoID, report_reason_id: reportID, description: reportReason) { (isSuccess, response) in
            if isSuccess{
