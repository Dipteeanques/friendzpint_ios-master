...
class DiscoverCell: UITableViewCell,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let obj = showsound[indexPath.row]
...
//        cell.btnFav.addTarget(self, action: #selector(discoverSearchViewController.btnSoundFavAction(_:)), for:.touchUpInside)
    ...
    @objc func btnSoundFavAction(_ sender : UIButton) {
        ...
        let obj = showsound[indexPath!.row]//soundsObj[indexPath!.row]
    ...
    @objc func btnSelectAction(_ sender : UIButton) {
        ...
        let newObj = showsound[sender.tag]
    ...
    func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        ...
        let visiblePaths = collectionView.indexPathsForVisibleItems
            ...
            for i in visiblePaths  {
                ...
                cell?.playImg.image = UIImage(named: "Play")
                cell?.btnSelect.isHidden = true
