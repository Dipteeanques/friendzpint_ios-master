...
class HashtagSearchTimelineController: UIViewController,TTTAttributedLabelDelegate {
...
//        
    ...
    func getHashtagPost() {
        let parameters = ["hashtag": hashtagpost] as [String : Any]
...
extension HashtagSearchTimelineController: UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case "image":
            ...
            cell.btnSingaleImg.addTarget(self, action: #selector(HashtagSearchTimelineController.openAction), for: UIControl.Event.touchUpInside)
            cell.btnSingaleImageMenu.addTarget(self, action: #selector(HashtagSearchTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnImgLike.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgLikeAction), for: UIControl.Event.touchUpInside)
            cell.btnComment.addTarget(self, action: #selector(HashtagSearchTimelineController.btnCommentAction), for: UIControl.Event.touchUpInside)
            cell.btnpostComment.addTarget(self, action: #selector(HashtagSearchTimelineController.btnCommentPostAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeImgCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnLikeImgcellAction), for: UIControl.Event.touchUpInside)
            cell.btnProImgClick.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.dislike.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeAction), for: UIControl.Event.touchUpInside)
            cell.dislikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "multi_image" :
            ...
            cell.btnLikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllLikeMultiCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllCommentMultiCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentMulticell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnCommentMultiCellAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeMulticell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnLikeMulticellAction), for: UIControl.Event.touchUpInside)
            cell.btnMultiImgmenu.addTarget(self, action: #selector(HashtagSearchTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnMultiImagePass.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgPassAction), for: UIControl.Event.touchUpInside)
            cell.btnMultiimgProfile.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeMultiAction), for: UIControl.Event.touchUpInside)
            cell.btnDislikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "text":
            ...
            cell.updateConstraintsIfNeeded()
            cell.sizeToFit()
            cell.btnLikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllLikeTxtCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllCommenttxtCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommenttxtCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnCommenttxtCellAction), for: UIControl.Event.touchUpInside)
            cell.btnLiketxtCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnLiketxtcellAction), for: UIControl.Event.touchUpInside)
            cell.btntxtMenu.addTarget(self, action: #selector(HashtagSearchTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btntxtProfile.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeTxtAction), for: UIControl.Event.touchUpInside)
            cell.btnDislikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "url":
            ...
            cell.btnLikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllLikeVideoCellAction), for: UIControl.Event.touchUpInside)
            cell.btncommentcount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllCommentVideoCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentVideoCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnCommentVideoCellAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeVideoCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnLikevideocellAction), for: UIControl.Event.touchUpInside)
            cell.btnVideoMenu.addTarget(self, action: #selector(HashtagSearchTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnVideoprofile.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeVideoAction), for: UIControl.Event.touchUpInside)
            cell.btndislikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "meta":
            ...
            cell.btnLikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllLikeMetaCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btnAllCommentMetaCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentMetaCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnCommentMetaCellAction), for: UIControl.Event.touchUpInside)
            cell.viewMeta.clipsToBounds = true
            cell.btnMetaClick.addTarget(self, action: #selector(HashtagSearchTimelineController.btnMetaAction), for: .touchUpInside)
            cell.btnMetaMenu.addTarget(self, action: #selector(HashtagSearchTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeMetaCell.addTarget(self, action: #selector(HashtagSearchTimelineController.btnLikeMetacellAction), for: UIControl.Event.touchUpInside)
            cell.btnMetaProfile.addTarget(self, action: #selector(HashtagSearchTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeMetaAction), for: UIControl.Event.touchUpInside)
            cell.btndislikeCount.addTarget(self, action: #selector(HashtagSearchTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
...
extension HashtagSearchTimelineController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
...
extension HashtagSearchTimelineController: SquareFlowLayoutDelegate {
