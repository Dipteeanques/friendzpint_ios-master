...
class PageTimelineController: UIViewController,TTTAttributedLabelDelegate {
...
extension PageTimelineController: UITableViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching{
...
extension PageTimelineController {
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
...
extension PageTimelineController: YPImagePickerDelegate{
    // MARK: - Configuration
    @objc
    func showPicker() {
