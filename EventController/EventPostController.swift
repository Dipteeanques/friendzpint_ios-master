...
class EventPostController: UIViewController,TTTAttributedLabelDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector: #selector(EventPostController.GroupView), name: NSNotification.Name(rawValue: "EventprofileTimeline"), object: nil)
    }
...
//        NotificationCenter.default.addObserver(self, selector: #selector(PageTimelineController.notificationMyTimelineBackSingale), name: NSNotification.Name(rawValue: "notificationMyTimelineBackSingale"), object: nil)
    ...
    @objc func GroupView(_ notification: NSNotification) {
        if let object = notification.object as? [String: Any] {
            ...
            if let group_request = object["is_page_admin"] as? String {
...
extension EventPostController: UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case "image":
            ...
            cell.btnSingaleImg.addTarget(self, action: #selector(EventPostController.openAction), for: UIControl.Event.touchUpInside)
            cell.btnSingaleImageMenu.addTarget(self, action: #selector(EventPostController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnImgLike.addTarget(self, action: #selector(EventPostController.btnImgLikeAction), for: UIControl.Event.touchUpInside)
            cell.btnComment.addTarget(self, action: #selector(EventPostController.btnCommentAction), for: UIControl.Event.touchUpInside)
            cell.btnpostComment.addTarget(self, action: #selector(EventPostController.btnCommentPostAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeImgCell.addTarget(self, action: #selector(EventPostController.btnLikeImgcellAction), for: UIControl.Event.touchUpInside)
            cell.btnProImgClick.addTarget(self, action: #selector(EventPostController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.dislike.addTarget(self, action: #selector(EventPostController.btndislikeAction), for: UIControl.Event.touchUpInside)
            cell.dislikeCount.addTarget(self, action: #selector(EventPostController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "multi_image" :
            ...
            cell.btnLikeCount.addTarget(self, action: #selector(EventPostController.btnAllLikeMultiCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentCount.addTarget(self, action: #selector(EventPostController.btnAllCommentMultiCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentMulticell.addTarget(self, action: #selector(EventPostController.btnCommentMultiCellAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeMulticell.addTarget(self, action: #selector(EventPostController.btnLikeMulticellAction), for: UIControl.Event.touchUpInside)
            cell.btnMultiImgmenu.addTarget(self, action: #selector(EventPostController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnMultiImagePass.addTarget(self, action: #selector(EventPostController.btnImgPassAction), for: UIControl.Event.touchUpInside)
            cell.btnMultiimgProfile.addTarget(self, action: #selector(EventPostController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(EventPostController.btndislikeMultiAction), for: UIControl.Event.touchUpInside)
            cell.btnDislikeCount.addTarget(self, action: #selector(EventPostController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "text":
            ...
            cell.updateConstraintsIfNeeded()
            cell.sizeToFit()
            cell.btnLikeCount.addTarget(self, action: #selector(EventPostController.btnAllLikeTxtCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentCount.addTarget(self, action: #selector(EventPostController.btnAllCommenttxtCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommenttxtCell.addTarget(self, action: #selector(EventPostController.btnCommenttxtCellAction), for: UIControl.Event.touchUpInside)
            cell.btnLiketxtCell.addTarget(self, action: #selector(EventPostController.btnLiketxtcellAction), for: UIControl.Event.touchUpInside)
            cell.btntxtMenu.addTarget(self, action: #selector(EventPostController.btnMenuAction), for: UIControl.Event.touchUpInside)
            //cell.btnSharetxtCell.addTarget(self, action: #selector(EventPostController.btnshareTxtAction), for: UIControl.Event.touchUpInside)
            cell.btntxtProfile.addTarget(self, action: #selector(EventPostController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(EventPostController.btndislikeTxtAction), for: UIControl.Event.touchUpInside)
            cell.btnDislikeCount.addTarget(self, action: #selector(EventPostController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "url":
            ...
            cell.btnLikeCount.addTarget(self, action: #selector(EventPostController.btnAllLikeVideoCellAction), for: UIControl.Event.touchUpInside)
            cell.btncommentcount.addTarget(self, action: #selector(EventPostController.btnAllCommentVideoCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentVideoCell.addTarget(self, action: #selector(EventPostController.btnCommentVideoCellAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeVideoCell.addTarget(self, action: #selector(EventPostController.btnLikevideocellAction), for: UIControl.Event.touchUpInside)
            //            cell.btnmute.addTarget(self, action: #selector(NewsfeedViewController.btnMuteAction), for: UIControl.Event.touchUpInside)
            cell.btnVideoMenu.addTarget(self, action: #selector(EventPostController.btnMenuAction), for: UIControl.Event.touchUpInside)
            //cell.btnshareVideoCell.addTarget(self, action: #selector(EventPostController.btnsharevideoAction), for: UIControl.Event.touchUpInside)
            cell.btnVideoprofile.addTarget(self, action: #selector(EventPostController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(EventPostController.btndislikeVideoAction), for: UIControl.Event.touchUpInside)
            cell.btndislikeCount.addTarget(self, action: #selector(EventPostController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
        ...
        case "meta":
            ...
            cell.btnLikeCount.addTarget(self, action: #selector(EventPostController.btnAllLikeMetaCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentCount.addTarget(self, action: #selector(EventPostController.btnAllCommentMetaCellAction), for: UIControl.Event.touchUpInside)
            cell.btnCommentMetaCell.addTarget(self, action: #selector(EventPostController.btnCommentMetaCellAction), for: UIControl.Event.touchUpInside)
            cell.viewMeta.clipsToBounds = true
            cell.btnMetaClick.addTarget(self, action: #selector(EventPostController.btnMetaAction), for: .touchUpInside)
            cell.btnMetaMenu.addTarget(self, action: #selector(EventPostController.btnMenuAction), for: UIControl.Event.touchUpInside)
            cell.btnLikeMetaCell.addTarget(self, action: #selector(EventPostController.btnLikeMetacellAction), for: UIControl.Event.touchUpInside)
           // cell.btnShareMetaCell.addTarget(self, action: #selector(EventPostController.btnsharemetaAction), for: UIControl.Event.touchUpInside)
            cell.btnMetaProfile.addTarget(self, action: #selector(EventPostController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
            cell.btndislike.addTarget(self, action: #selector(EventPostController.btndislikeMetaAction), for: UIControl.Event.touchUpInside)
            cell.btndislikeCount.addTarget(self, action: #selector(EventPostController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
...
extension EventPostController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
...
extension EventPostController: SquareFlowLayoutDelegate {
