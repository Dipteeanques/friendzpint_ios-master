...
class EventGuestsViewcontroller: UIViewController {
    ...
    func getEvent() {
        let username = loggdenUser.value(forKey: EVENTUSERNAME)as! String
...
extension EventGuestsViewcontroller : UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
