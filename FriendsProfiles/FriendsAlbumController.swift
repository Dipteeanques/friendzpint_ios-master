...
class FriendsAlbumController: UIViewController {
...
extension FriendsAlbumController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate {
