...
class FriendsGuestEventController: UIViewController {
...
extension FriendsGuestEventController : UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
