...
class tblFriendsTimelineCell: UITableViewCell,ASAutoPlayVideoLayerContainer {
    ...
    func setDescription(lblDesc: String) {
        lblDetails.text = lblDesc
        lblDetails.enabledTypes = [.mention, .hashtag, .url]
        lblDetails.textColor = .black
        lblDetails.hashtagColor = .lightGray
        lblDetails.hashtagSelectedColor = .blue
        lblDetails.handleHashtagTap { hashtag in
            print("Success:", hashtag)
        }
    }
