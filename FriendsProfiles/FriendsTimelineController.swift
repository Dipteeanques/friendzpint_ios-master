...
//        imageViewMain.backgroundColor = .clear
        ...
        btnClose.frame = CGRect(x:self.loaderView.frame.width - 50 , y: 40, width: 50, height: 50)
...
//}
    ...
    extension FriendsTimelineController: UITableViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching{
    ...
    extension FriendsTimelineController {
        func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
    ...
    extension FriendsTimelineController: YPImagePickerDelegate{
        // MARK: - Configuration
        @objc
        func showPicker() {
