...
class GroupTimelineSetController: UIViewController,TTTAttributedLabelDelegate {
...
//    @IBOutlet weak var foundView: Foundview!
    ...
    var arrSingaleImg = ["https://washington-org.s3.amazonaws.com/s3fs-public/styles/article_hero_breakpoints_theme_washington_lg_1x/public/rock-creek-park-fallfoliage_2015-ddc-photo.jpg?itok=HYNROoX-&timestamp=1482354368"]
...
//    func setDefault() {
//        NotificationCenter.default.addObserver(self, selector: #selector(PageTimelineController.GetCreatedPost), name: NSNotification.Name(rawValue: "PostCreat"), object: nil)
...
//                          "username":strUserName] as [String : Any]
//        print("para-timeline: ",parameters)
//        let token = loggdenUser.value(forKey: TOKEN)as! String
//        let BEARERTOKEN = BEARER + token
//        let headers: HTTPHeaders = ["Xapi": XAPI,
//                                    "Accept" : ACCEPT,
...
//extension PageTimelineController: UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
//
...
//            cell.btnSingaleImg.addTarget(self, action: #selector(PageTimelineController.openAction), for: UIControl.Event.touchUpInside)
//            cell.btnSingaleImageMenu.addTarget(self, action: #selector(PageTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
//            cell.btnImgLike.addTarget(self, action: #selector(PageTimelineController.btnImgLikeAction), for: UIControl.Event.touchUpInside)
//            cell.btnComment.addTarget(self, action: #selector(PageTimelineController.btnCommentAction), for: UIControl.Event.touchUpInside)
//            cell.btnpostComment.addTarget(self, action: #selector(PageTimelineController.btnCommentPostAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeImgCell.addTarget(self, action: #selector(PageTimelineController.btnLikeImgcellAction), for: UIControl.Event.touchUpInside)
//           // cell.btnShareimgCell.addTarget(self, action: #selector(PageTimelineController.btnshareImgAction), for: UIControl.Event.touchUpInside)
//            cell.btnProImgClick.addTarget(self, action: #selector(PageTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.dislike.addTarget(self, action: #selector(PageTimelineController.btndislikeAction), for: UIControl.Event.touchUpInside)
//            cell.dislikeCount.addTarget(self, action: #selector(PageTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//            let shared_person_name = arrFeed[indexPath.row].shared_person_name
//            let shared_username = arrFeed[indexPath.row].shared_username
...
//                self.getHashtagPost()
//            }
//            cell.btnLikeCount.addTarget(self, action: #selector(PageTimelineController.btnAllLikeMultiCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentCount.addTarget(self, action: #selector(PageTimelineController.btnAllCommentMultiCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentMulticell.addTarget(self, action: #selector(PageTimelineController.btnCommentMultiCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeMulticell.addTarget(self, action: #selector(PageTimelineController.btnLikeMulticellAction), for: UIControl.Event.touchUpInside)
//            cell.btnMultiImgmenu.addTarget(self, action: #selector(PageTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
//           // cell.btnshareMultiCell.addTarget(self, action: #selector(PageTimelineController.btnshareMultiAction), for: UIControl.Event.touchUpInside)
//            cell.btnMultiImagePass.addTarget(self, action: #selector(PageTimelineController.btnImgPassAction), for: UIControl.Event.touchUpInside)
//            cell.btnMultiimgProfile.addTarget(self, action: #selector(PageTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(PageTimelineController.btndislikeMultiAction), for: UIControl.Event.touchUpInside)
//            cell.btnDislikeCount.addTarget(self, action: #selector(PageTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//
...
//            cell.updateConstraintsIfNeeded()
//            cell.sizeToFit()
//            cell.btnLikeCount.addTarget(self, action: #selector(PageTimelineController.btnAllLikeTxtCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentCount.addTarget(self, action: #selector(PageTimelineController.btnAllCommenttxtCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommenttxtCell.addTarget(self, action: #selector(PageTimelineController.btnCommenttxtCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnLiketxtCell.addTarget(self, action: #selector(PageTimelineController.btnLiketxtcellAction), for: UIControl.Event.touchUpInside)
//            cell.btntxtMenu.addTarget(self, action: #selector(PageTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
//            //cell.btnSharetxtCell.addTarget(self, action: #selector(PageTimelineController.btnshareTxtAction), for: UIControl.Event.touchUpInside)
//            cell.btntxtProfile.addTarget(self, action: #selector(PageTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(PageTimelineController.btndislikeTxtAction), for: UIControl.Event.touchUpInside)
//            cell.btnDislikeCount.addTarget(self, action: #selector(PageTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//
//            return cell
...
//            }
//
//            cell.btnLikeCount.addTarget(self, action: #selector(PageTimelineController.btnAllLikeVideoCellAction), for: UIControl.Event.touchUpInside)
//            cell.btncommentcount.addTarget(self, action: #selector(PageTimelineController.btnAllCommentVideoCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentVideoCell.addTarget(self, action: #selector(PageTimelineController.btnCommentVideoCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeVideoCell.addTarget(self, action: #selector(PageTimelineController.btnLikevideocellAction), for: UIControl.Event.touchUpInside)
//            //            cell.btnmute.addTarget(self, action: #selector(NewsfeedViewController.btnMuteAction), for: UIControl.Event.touchUpInside)
//            cell.btnVideoMenu.addTarget(self, action: #selector(PageTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
//            //cell.btnshareVideoCell.addTarget(self, action: #selector(PageTimelineController.btnsharevideoAction), for: UIControl.Event.touchUpInside)
//            cell.btnVideoprofile.addTarget(self, action: #selector(PageTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(PageTimelineController.btndislikeVideoAction), for: UIControl.Event.touchUpInside)
//            cell.btndislikeCount.addTarget(self, action: #selector(PageTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//
//            cell.layoutMargins = UIEdgeInsets.zero
...
//            }
//
//            cell.btnLikeCount.addTarget(self, action: #selector(PageTimelineController.btnAllLikeMetaCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentCount.addTarget(self, action: #selector(PageTimelineController.btnAllCommentMetaCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentMetaCell.addTarget(self, action: #selector(PageTimelineController.btnCommentMetaCellAction), for: UIControl.Event.touchUpInside)
//            cell.viewMeta.clipsToBounds = true
//            cell.btnMetaClick.addTarget(self, action: #selector(PageTimelineController.btnMetaAction), for: .touchUpInside)
//            cell.btnMetaMenu.addTarget(self, action: #selector(PageTimelineController.btnMenuAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeMetaCell.addTarget(self, action: #selector(PageTimelineController.btnLikeMetacellAction), for: UIControl.Event.touchUpInside)
//           // cell.btnShareMetaCell.addTarget(self, action: #selector(PageTimelineController.btnsharemetaAction), for: UIControl.Event.touchUpInside)
//            cell.btnMetaProfile.addTarget(self, action: #selector(PageTimelineController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(PageTimelineController.btndislikeMetaAction), for: UIControl.Event.touchUpInside)
//            cell.btndislikeCount.addTarget(self, action: #selector(PageTimelineController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//            cell.layoutMargins = UIEdgeInsets.zero
//            cell.separatorInset = UIEdgeInsets.zero
...
//extension PageTimelineController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
...
//extension PageTimelineController: SquareFlowLayoutDelegate {
...
extension GroupTimelineSetController: UITableViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching{
...
extension GroupTimelineSetController {
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
...
extension GroupTimelineSetController: YPImagePickerDelegate{
    // MARK: - Configuration
    @objc
    func showPicker() {
...
//    override func viewDidLoad() {
//        super.viewDidLoad()
//        NotificationCenter.default.addObserver(self, selector: #selector(GroupTimelineSetController.GroupView), name: NSNotification.Name(rawValue: "GroupprofileTimeline"), object: nil)
//    }
//
//    func setDefault() {
//              NotificationCenter.default.addObserver(self, selector: #selector(GroupTimelineSetController.GetCreatedPost), name: NSNotification.Name(rawValue: "PostCreat"), object: nil)
//        refreshControl.addTarget(self, action: #selector(GroupTimelineSetController.refresh), for: UIControl.Event.valueChanged)
//        tblFeed.addSubview(refreshControl)
//        NotificationCenter.default.addObserver(self, selector: #selector(self.appEnteredFromBackground), name: UIApplication.willEnterForegroundNotification, object: nil)
//
//        NotificationCenter.default.addObserver(self, selector: #selector(GroupTimelineSetController.notificationSingaleDashboardTimeline), name: NSNotification.Name(rawValue: "notificationSingaleDashboardTimeline"), object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(GroupTimelineSetController.notificationMyTimelineBackSingale), name: NSNotification.Name(rawValue: "notificationMyTimelineBackSingale"), object: nil)
//
//        tblFeed.register(UINib(nibName: "ImgcellTimeline", bundle: nil), forCellReuseIdentifier: "ImgcellTimeline")
//        tblFeed.register(UINib(nibName: "MultiImgcellTimeline", bundle: nil), forCellReuseIdentifier: "MultiImgcellTimeline")
//        tblFeed.register(UINib(nibName: "TxtcellTimeline", bundle: nil), forCellReuseIdentifier: "TxtcellTimeline")
...
//                print(strUserName)
//            }
//            if let group_request = object["group_request"] as? String {
//                if group_request == "MyGroup" {
//                    btnFloat.isHidden = false
//                }
//                else {
//                    btnFloat.isHidden = true
//                }
//            }
//            if let post = object["onlyPost"] as? String {
//                if post == "only_guests" {
//                    btnFloat.isHidden = false
//                }
//            }
...
//        self.navigationController?.pushViewController(obj, animated: false)
//    }
//    @IBAction func btnFloattingAction(_ sender: UIButton) {
//        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "Videopause"), object: nil)
...
//MARK: - tableview method
//extension GroupTimelineSetController: UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
//
//    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
//        return arrFeed.count
//    }
...
//            let selectedUsername = arrFeed[indexPath.row].username
//
//            cell.btnSingaleImg.addTarget(self, action: #selector(GroupTimelineSetController.openAction), for: UIControl.Event.touchUpInside)
//            cell.btnSingaleImageMenu.addTarget(self, action: #selector(GroupTimelineSetController.btnMenuAction), for: UIControl.Event.touchUpInside)
//            cell.btnImgLike.addTarget(self, action: #selector(GroupTimelineSetController.btnImgLikeAction), for: UIControl.Event.touchUpInside)
//            cell.btnComment.addTarget(self, action: #selector(GroupTimelineSetController.btnCommentAction), for: UIControl.Event.touchUpInside)
//            cell.btnpostComment.addTarget(self, action: #selector(GroupTimelineSetController.btnCommentPostAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeImgCell.addTarget(self, action: #selector(GroupTimelineSetController.btnLikeImgcellAction), for: UIControl.Event.touchUpInside)
//            cell.btnProImgClick.addTarget(self, action: #selector(GroupTimelineSetController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.dislike.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeAction), for: UIControl.Event.touchUpInside)
//            cell.dislikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//            let shared_person_name = arrFeed[indexPath.row].shared_person_name
//            let shared_username = arrFeed[indexPath.row].shared_username
//            if shared_person_name.count == 0 {
...
//                self.getHashtagPost()
//            }
//            cell.btnLikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllLikeMultiCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllCommentMultiCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentMulticell.addTarget(self, action: #selector(GroupTimelineSetController.btnCommentMultiCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeMulticell.addTarget(self, action: #selector(GroupTimelineSetController.btnLikeMulticellAction), for: UIControl.Event.touchUpInside)
//            cell.btnMultiImgmenu.addTarget(self, action: #selector(GroupTimelineSetController.btnMenuAction), for: UIControl.Event.touchUpInside)
//
//            cell.btnMultiImagePass.addTarget(self, action: #selector(GroupTimelineSetController.btnImgPassAction), for: UIControl.Event.touchUpInside)
//            cell.btnMultiimgProfile.addTarget(self, action: #selector(GroupTimelineSetController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeMultiAction), for: UIControl.Event.touchUpInside)
//            cell.btnDislikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//            cell.layoutMargins = UIEdgeInsets.zero
//            cell.separatorInset = UIEdgeInsets.zero
//            cell.setNeedsUpdateConstraints()
...
//            cell.updateConstraintsIfNeeded()
//            cell.sizeToFit()
//            cell.btnLikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllLikeTxtCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllCommenttxtCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommenttxtCell.addTarget(self, action: #selector(GroupTimelineSetController.btnCommenttxtCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnLiketxtCell.addTarget(self, action: #selector(GroupTimelineSetController.btnLiketxtcellAction), for: UIControl.Event.touchUpInside)
//            cell.btntxtMenu.addTarget(self, action: #selector(GroupTimelineSetController.btnMenuAction), for: UIControl.Event.touchUpInside)
//           // cell.btnSharetxtCell.addTarget(self, action: #selector(GroupTimelineSetController.btnshareTxtAction), for: UIControl.Event.touchUpInside)
//            cell.btntxtProfile.addTarget(self, action: #selector(GroupTimelineSetController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeTxtAction), for: UIControl.Event.touchUpInside)
//            cell.btnDislikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//
//            return cell
...
//            }
//
//            cell.btnLikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllLikeVideoCellAction), for: UIControl.Event.touchUpInside)
//            cell.btncommentcount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllCommentVideoCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentVideoCell.addTarget(self, action: #selector(GroupTimelineSetController.btnCommentVideoCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeVideoCell.addTarget(self, action: #selector(GroupTimelineSetController.btnLikevideocellAction), for: UIControl.Event.touchUpInside)
//            //            cell.btnmute.addTarget(self, action: #selector(NewsfeedViewController.btnMuteAction), for: UIControl.Event.touchUpInside)
//            cell.btnVideoMenu.addTarget(self, action: #selector(GroupTimelineSetController.btnMenuAction), for: UIControl.Event.touchUpInside)
//           // cell.btnshareVideoCell.addTarget(self, action: #selector(GroupTimelineSetController.btnsharevideoAction), for: UIControl.Event.touchUpInside)
//            cell.btnVideoprofile.addTarget(self, action: #selector(GroupTimelineSetController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeVideoAction), for: UIControl.Event.touchUpInside)
//            cell.btndislikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//
//            cell.layoutMargins = UIEdgeInsets.zero
...
//            }
//
//            cell.btnLikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllLikeMetaCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentCount.addTarget(self, action: #selector(GroupTimelineSetController.btnAllCommentMetaCellAction), for: UIControl.Event.touchUpInside)
//            cell.btnCommentMetaCell.addTarget(self, action: #selector(GroupTimelineSetController.btnCommentMetaCellAction), for: UIControl.Event.touchUpInside)
//            cell.viewMeta.clipsToBounds = true
//            cell.btnMetaClick.addTarget(self, action: #selector(GroupTimelineSetController.btnMetaAction), for: .touchUpInside)
//            cell.btnMetaMenu.addTarget(self, action: #selector(GroupTimelineSetController.btnMenuAction), for: UIControl.Event.touchUpInside)
//            cell.btnLikeMetaCell.addTarget(self, action: #selector(GroupTimelineSetController.btnLikeMetacellAction), for: UIControl.Event.touchUpInside)
//           // cell.btnShareMetaCell.addTarget(self, action: #selector(GroupTimelineSetController.btnsharemetaAction), for: UIControl.Event.touchUpInside)
//            cell.btnMetaProfile.addTarget(self, action: #selector(GroupTimelineSetController.btnImgProfileClickAction), for: UIControl.Event.touchUpInside)
//            cell.btndislike.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeMetaAction), for: UIControl.Event.touchUpInside)
//            cell.btndislikeCount.addTarget(self, action: #selector(GroupTimelineSetController.btndislikeCountAction), for: UIControl.Event.touchUpInside)
//
//            cell.layoutMargins = UIEdgeInsets.zero
//            cell.separatorInset = UIEdgeInsets.zero
...
//extension GroupTimelineSetController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
//    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
//        return arrMultiImage.count
//    }
//
...
//extension GroupTimelineSetController: SquareFlowLayoutDelegate {
//    func shouldExpandItem(at indexPath: IndexPath) -> Bool {
//        if arrMultiImage.count == 5 {
//            return self.layoutValues[indexPath.row] == .normal
//        }
...
extension GroupTimelineSetController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case "multi_image" :
            ...
            cell.imgProfile.kf.setImage(with: URL(string: arrFeed[indexPath.row].images[0]),placeholder:UIImage(named: "Placeholder"))
            break
