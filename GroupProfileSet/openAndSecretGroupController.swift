...
class openAndSecretGroupController: MXSegmentedPagerController {
    ...
    func setDefault() {
        NotificationCenter.default.addObserver(self, selector: #selector(openAndSecretGroupController.GetCreatedGroup), name: NSNotification.Name(rawValue: "GroupCreat"), object: nil)
        getGroupDetails()
