...
class GroupProfileViewController: MXSegmentedPagerController {
    ...
    func setDefault() {
        NotificationCenter.default.addObserver(self, selector: #selector(GroupProfileViewController.GetCreatedGroup), name: NSNotification.Name(rawValue: "GroupCreat"), object: nil)
        getGroupDetails()
