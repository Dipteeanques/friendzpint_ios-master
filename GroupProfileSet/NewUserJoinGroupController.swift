...
class NewUserJoinGroupController: MXSegmentedPagerController {
    ...
    func setDefault() {
        NotificationCenter.default.addObserver(self, selector: #selector(NewUserJoinGroupController.GetCreatedGroup), name: NSNotification.Name(rawValue: "GroupCreat"), object: nil)
        getGroupDetails()
