...
class UserJoinedGroupViewController: MXSegmentedPagerController {
    ...
    func setDefault() {
        NotificationCenter.default.addObserver(self, selector: #selector(UserJoinedGroupViewController.GetCreatedGroup), name: NSNotification.Name(rawValue: "GroupCreat"), object: nil)
        getGroupDetails()
