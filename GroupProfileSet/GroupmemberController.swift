...
class GroupmemberController: UIViewController {
    ...
    func getMember() {
        ...
        wc.callSimplewebservice(url: GETGROUPMEMBER, parameters: parameters, headers: headers, fromView: self.view, isLoading: false) { (sucess, response: groupMemberListResponseGet?) in
            if sucess {
...
extension GroupmemberController : UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if is_page_admin == 1 {
            ...
            btnAdmin.addTarget(self, action: #selector(GroupmemberController.btnAdminAction), for: UIControl.Event.touchUpInside)
